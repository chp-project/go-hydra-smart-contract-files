...
// ChainpointRegistry is a free data retrieval call binding the contract method 0xba60ad97.
//
// Solidity: function chainpointRegistry() constant returns(address)
func (_TNT *TNTCaller) ChainpointRegistry(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _TNT.contract.Call(opts, out, "chainpointRegistry")
	return *ret0, err
}
...
//
// Solidity: function chainpointRegistry() constant returns(address)
func (_TNT *TNTSession) ChainpointRegistry() (common.Address, error) {
	return _TNT.Contract.ChainpointRegistry(&_TNT.CallOpts)
}

// ChainpointRegistry is a free data retrieval call binding the contract method 0xba60ad97.
//
// Solidity: function chainpointRegistry() constant returns(address)
func (_TNT *TNTCallerSession) ChainpointRegistry() (common.Address, error) {
	return _TNT.Contract.ChainpointRegistry(&_TNT.CallOpts)
}
...
// CoreMintingSignaturesUsed is a free data retrieval call binding the contract method 0xdeb29ccc.
//
// Solidity: function coreMintingSignaturesUsed(uint256 , address ) constant returns(bool)
func (_TNT *TNTCaller) CoreMintingSignaturesUsed(opts *bind.CallOpts, arg0 *big.Int, arg1 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _TNT.contract.Call(opts, out, "coreMintingSignaturesUsed", arg0, arg1)
	return *ret0, err
}
...
//
// Solidity: function coreMintingSignaturesUsed(uint256 , address ) constant returns(bool)
func (_TNT *TNTSession) CoreMintingSignaturesUsed(arg0 *big.Int, arg1 common.Address) (bool, error) {
	return _TNT.Contract.CoreMintingSignaturesUsed(&_TNT.CallOpts, arg0, arg1)
}

// CoreMintingSignaturesUsed is a free data retrieval call binding the contract method 0xdeb29ccc.
//
// Solidity: function coreMintingSignaturesUsed(uint256 , address ) constant returns(bool)
func (_TNT *TNTCallerSession) CoreMintingSignaturesUsed(arg0 *big.Int, arg1 common.Address) (bool, error) {
	return _TNT.Contract.CoreMintingSignaturesUsed(&_TNT.CallOpts, arg0, arg1)
}
...
// IsMigrationContract is a free data retrieval call binding the contract method 0x59c2ff07.
//
// Solidity: function isMigrationContract() constant returns(bool)
func (_TNT *TNTCaller) IsMigrationContract(opts *bind.CallOpts) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _TNT.contract.Call(opts, out, "isMigrationContract")
	return *ret0, err
}
...
//
// Solidity: function isMigrationContract() constant returns(bool)
func (_TNT *TNTSession) IsMigrationContract() (bool, error) {
	return _TNT.Contract.IsMigrationContract(&_TNT.CallOpts)
}

// IsMigrationContract is a free data retrieval call binding the contract method 0x59c2ff07.
//
// Solidity: function isMigrationContract() constant returns(bool)
func (_TNT *TNTCallerSession) IsMigrationContract() (bool, error) {
	return _TNT.Contract.IsMigrationContract(&_TNT.CallOpts)
}
...
// MigrationContract is a free data retrieval call binding the contract method 0x0fee1a20.
//
// Solidity: function migrationContract() constant returns(address)
func (_TNT *TNTCaller) MigrationContract(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _TNT.contract.Call(opts, out, "migrationContract")
	return *ret0, err
}
...
//
// Solidity: function migrationContract() constant returns(address)
func (_TNT *TNTSession) MigrationContract() (common.Address, error) {
	return _TNT.Contract.MigrationContract(&_TNT.CallOpts)
}

// MigrationContract is a free data retrieval call binding the contract method 0x0fee1a20.
//
// Solidity: function migrationContract() constant returns(address)
func (_TNT *TNTCallerSession) MigrationContract() (common.Address, error) {
	return _TNT.Contract.MigrationContract(&_TNT.CallOpts)
}
...
// NodeLastMintedAt is a free data retrieval call binding the contract method 0x898e0025.
//
// Solidity: function nodeLastMintedAt() constant returns(uint256)
func (_TNT *TNTCaller) NodeLastMintedAt(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _TNT.contract.Call(opts, out, "nodeLastMintedAt")
	return *ret0, err
}
...
//
// Solidity: function nodeLastMintedAt() constant returns(uint256)
func (_TNT *TNTSession) NodeLastMintedAt() (*big.Int, error) {
	return _TNT.Contract.NodeLastMintedAt(&_TNT.CallOpts)
}

// NodeLastMintedAt is a free data retrieval call binding the contract method 0x898e0025.
//
// Solidity: function nodeLastMintedAt() constant returns(uint256)
func (_TNT *TNTCallerSession) NodeLastMintedAt() (*big.Int, error) {
	return _TNT.Contract.NodeLastMintedAt(&_TNT.CallOpts)
}
...
// MintCores is a paid mutator transaction binding the contract method 0xcd3e4798.
//
// Solidity: function mintCores(address[] _cores, bytes32 _hash, bytes[126] sigs) returns(bool)
func (_TNT *TNTTransactor) MintCores(opts *bind.TransactOpts, _cores []common.Address, _hash [32]byte, sigs [126][]byte) (*types.Transaction, error) {
	return _TNT.contract.Transact(opts, "mintCores", _cores, _hash, sigs)
}

// MintCores is a paid mutator transaction binding the contract method 0xcd3e4798.
//
// Solidity: function mintCores(address[] _cores, bytes32 _hash, bytes[126] sigs) returns(bool)
func (_TNT *TNTSession) MintCores(_cores []common.Address, _hash [32]byte, sigs [126][]byte) (*types.Transaction, error) {
	return _TNT.Contract.MintCores(&_TNT.TransactOpts, _cores, _hash, sigs)
}

// MintCores is a paid mutator transaction binding the contract method 0xcd3e4798.
//
// Solidity: function mintCores(address[] _cores, bytes32 _hash, bytes[126] sigs) returns(bool)
func (_TNT *TNTTransactorSession) MintCores(_cores []common.Address, _hash [32]byte, sigs [126][]byte) (*types.Transaction, error) {
	return _TNT.Contract.MintCores(&_TNT.TransactOpts, _cores, _hash, sigs)
}

// MintForExchange is a paid mutator transaction binding the contract method 0xdcfd2b9f.
//
// Solidity: function mintForExchange(address _to, uint256 _amount) returns(bool)
func (_TNT *TNTTransactor) MintForExchange(opts *bind.TransactOpts, _to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _TNT.contract.Transact(opts, "mintForExchange", _to, _amount)
}

// MintForExchange is a paid mutator transaction binding the contract method 0xdcfd2b9f.
//
// Solidity: function mintForExchange(address _to, uint256 _amount) returns(bool)
func (_TNT *TNTSession) MintForExchange(_to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _TNT.Contract.MintForExchange(&_TNT.TransactOpts, _to, _amount)
}

// MintForExchange is a paid mutator transaction binding the contract method 0xdcfd2b9f.
//
// Solidity: function mintForExchange(address _to, uint256 _amount) returns(bool)
func (_TNT *TNTTransactorSession) MintForExchange(_to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _TNT.Contract.MintForExchange(&_TNT.TransactOpts, _to, _amount)
}
...
// TNTMintCoresIterator is returned from FilterMintCores and is used to iterate over the raw logs and unpacked data for MintCores events raised by the TNT contract.
type TNTMintCoresIterator struct {
	Event *TNTMintCores // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TNTMintCoresIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TNTMintCoresIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TNTMintCoresIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TNTMintCores represents a MintCores event raised by the TNT contract.
type TNTMintCores struct {
	RecoveredSigs *big.Int
	Majority      *big.Int
	Raw           types.Log // Blockchain specific contextual infos
}

// FilterMintCores is a free log retrieval operation binding the contract event 0x824f78bf2ab7a49cec00f2870b45c4a1aeedb5fb1f2472cd63cd721c5bd55fdd.
//
// Solidity: event MintCores(uint256 _recoveredSigs, uint256 _majority)
func (_TNT *TNTFilterer) FilterMintCores(opts *bind.FilterOpts) (*TNTMintCoresIterator, error) {

	logs, sub, err := _TNT.contract.FilterLogs(opts, "MintCores")
	if err != nil {
		return nil, err
	}
	return &TNTMintCoresIterator{contract: _TNT.contract, event: "MintCores", logs: logs, sub: sub}, nil
}

// WatchMintCores is a free log subscription operation binding the contract event 0x824f78bf2ab7a49cec00f2870b45c4a1aeedb5fb1f2472cd63cd721c5bd55fdd.
//
// Solidity: event MintCores(uint256 _recoveredSigs, uint256 _majority)
func (_TNT *TNTFilterer) WatchMintCores(opts *bind.WatchOpts, sink chan<- *TNTMintCores) (event.Subscription, error) {

	logs, sub, err := _TNT.contract.WatchLogs(opts, "MintCores")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TNTMintCores)
				if err := _TNT.contract.UnpackLog(event, "MintCores", log); err != nil {
					return err
				}
				event.Raw = log
